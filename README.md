...
## Estructura
- backend/ → Código fuente del servidor, consumo de la API OpenAQ, procesamiento de datos, conexión con MongoDB Atlas,
- y los datos llegan a la aplicación web progresiva, donde el usuario puede consultarlos de forma clara e interactiva.
